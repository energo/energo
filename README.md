...
<p>
  <img src="https://readme-typing-svg.demolab.com?font=Inter&weight=600&size=18&pause=1200&center=true&vCenter=true&width=900&lines=Flutter+iOS+Android+developer;Building+mobile+apps+and+real-time+products;Backend+APIs+%7C+WebRTC+%7C+CI%2FCD+%7C+Payments;Based+in+Europe" alt="Typing SVG" />
</p>
...
I’m a mobile and full-stack developer focused on building polished products for iOS, Android, and the web.
...
- 🔭 I’m currently working on mobile apps, product tooling, and real-time features.
...
- Android integrations and platform-specific features
- Backend APIs and real-time systems
- WebRTC and communication workflows
